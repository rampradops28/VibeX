...
export const createComment = async(req,res) => {
    try{
        ...
        console.log(`Error in commenting the post controller : ${error}`);
        res.status(400).json({error : "Internal server error"})  
    }
}
...
export const likeUnlikePost = async(req,res) => {
    try{
        ...
        console.log(`Error in like/unlike the post controller : ${error}`);
        res.status(400).json({error : "Internal server error"})  
    }
}
...
export const getAllPosts = async(req,res) => {
    try{
        ...
        console.log(`Error in get the posts controller : ${error}`);
        res.status(400).json({error : "Internal server error"})  
    }
}
